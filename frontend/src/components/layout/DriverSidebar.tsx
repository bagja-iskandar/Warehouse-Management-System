      ...
      >
        ...
        <div className="p-3 border-t border-slate-100 bg-slate-50/50">
          <div className="flex items-center justify-between p-2 rounded-xl bg-white border border-slate-200 shadow-sm">
            ...
            >
              <div className="h-7.5 w-7.5 rounded-lg bg-amber-500 text-slate-950 font-bold text-xs flex items-center justify-center flex-shrink-0 shadow-sm shadow-amber-500/20">
