      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Armada Berpendingin Khusus Cold Storage (Kapasitas: 12 m³)
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
          <div className="p-3.5 rounded-xl bg-sky-50/60 border border-sky-100">
            <span className="text-[11px] text-sky-800 font-semibold block">Suhu Box Reefer</span>
            ...
            <span className="text-[10px] text-sky-700 font-medium block mt-0.5">Target: -18.0°C s/d -20.0°C</span>
          </div>

          <div className="p-3.5 rounded-xl bg-emerald-50/60 border border-emerald-100">
            <span className="text-[11px] text-emerald-800 font-semibold block">Status Mesin Pendingin</span>
            <div className="flex items-center gap-1.5 mt-1">
              <span className="h-2.5 w-2.5 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-sm font-bold text-emerald-900">Aktif Optimal</span>
            </div>
            <span className="text-[10px] text-emerald-700 font-medium block mt-0.5">Kompresor Reefer Berjalan Normal</span>
          </div>

          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200">
            <span className="text-[11px] text-slate-500 font-semibold block">Total Muatan Aktif</span>
            <span className="text-sm font-bold text-slate-900 mt-1 block">
              150 Koli (Wagyu & Salmon)
            </span>
            <span className="text-[10px] text-slate-400 font-mono block mt-0.5">Setara 75 m³ • DO-2026-001</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-800">
                Gudang Utama Cakung (JKT-01) — Loading Dock 2
              </p>
              <span className="text-[10.5px] text-emerald-600 font-medium block mt-0.5">
                ✓ Muat Barang Selesai (08:15 WIB)
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-0.5">
                Penerima: Pak Hendra (0812-9988-7766)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-3 border-t border-slate-100">
          ...
          <Link href="/driver/pod">
            <Button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold rounded-xl h-10 flex items-center justify-center gap-1.5 shadow-md shadow-emerald-600/20">
              ...
              <span>Upload Bukti POD & Tanda Tangan</span>
            </Button>
          </Link>
        </div>
      </div>
