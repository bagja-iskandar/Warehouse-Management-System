...
export default function DriverProfilePage() {
  ...
  const [simType, setSimType] = useState("SIM B2 Commercial");
  const [simExpiry, setSimExpiry] = useState("Aug 14, 2028");
  const [emergencyContact, setEmergencyContact] = useState("Siti Rahma (Wife) — 0813-9988-1122");
    ...
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">
              Driver Profile & License Credentials
            </h1>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Driver&apos;s license (SIM) data, emergency contact, assigned fleet vehicle, and cold chain handling certifications.
          </p>
        </div>
      </div>
      ...
      {isSaved && (
        <div className="p-3 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl text-xs font-semibold flex items-center gap-2 animate-in fade-in">
          ...
          <span>Driver profile data updated successfully!</span>
        </div>
      )}
