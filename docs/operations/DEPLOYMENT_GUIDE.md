...
*Realisasi Penuh dari SRS Perkuliahan Menjadi Platform Cloud Enterprise: Next.js 15 Frontend on Vercel Edge, NestJS 10 Serverless Backend, and Supabase PostgreSQL on AWS Sydney*

---

> **Catatan Konteks & Asal-Usul Proyek**:
> Platform ini dibangun secara langsung berdasarkan dokumen spesifikasi kebutuhan sistem (*Software Requirements Specification* - SRS) pergudangan yang dirancang saat masa perkuliahan (16 Use Cases fungsional). Seluruh kebutuhan tersebut kini direalisasikan secara nyata menjadi arsitektur cloud-native modern berstandar industri dengan bantuan Google DeepMind Antigravity AI, Google Stitch, Supabase, dan Vercel.
