...
| **UC1** | **Melihat Riwayat** | Customer, Admin | Riwayat barang disimpan, diambil, dan jejak mutasi slot (*Rack Transfer*). | `/customer/history`, `/admin/goods`<br>`GET /api/v1/goods/mutations` | 🔒 **VERIFIED** |
