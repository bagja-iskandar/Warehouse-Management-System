...
Dokumen ini memuat catatan keputusan arsitektur teknis (*Architecture Decision Records*) yang mengatur pondasi, pilihan teknologi, dan standar rekayasa WMS Nusantara.
...
| [ADR-004](ADR-004-authentication-and-authorization.md) | Authentication & RBAC Authorization Strategy | **Accepted** | 2026-08-16 | **Stateless JWT** + **Bcrypt** + **RBAC Guards** |
